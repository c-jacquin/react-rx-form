...
var createInputObservable = function (_a) {
    ...
    return Observable.Observable.merge.apply(Observable.Observable, elements
        .filter(function (element) { return types.indexOf(element.type) !== -1; })
        .map(function (element) { return Observable.Observable.fromEvent(element, event); }));
};
var createSelectObservable = function (_a) {
    var elements = _a.elements, _b = _a.event, event = _b === void 0 ? 'change' : _b;
    return Observable.Observable.merge.apply(Observable.Observable, elements.map(function (element) { return Observable.Observable.fromEvent(element, event); }));
};
...
var InputObservable = (function (_super) {
    ...
    InputObservable.prototype.setValue = function (formValue) {
        Observable.Observable.of(this.handleBeforeValidation(formValue))
    ...
    InputObservable.prototype.handleError = function (formValue) {
        ...
        if (typeof field.validation === 'function') {
            return Observable.Observable.of(__assign({}, state, (_a = {}, _a[inputName] = __assign({}, formValue[inputName], { error: field.validation(formValue[inputName].value, this.formatState(state), this.props) }), _a)));
        }
            ...
            return Observable.Observable.of(formValue);
        }
        var _a, _b;
    };
    ...
    InputObservable.prototype.addInputs = function (inputElements, selectElements) {
        ...
        this.subscriptions.push(Observable.Observable.merge(text$, radio$, checkbox$, select$)
    ...
    return function (Comp) {
        var RxForm = (function (_super) {
            ...
            function RxForm() {
                ...
                _this.valueChangeSubscription = new Subscription.Subscription();
                _this.formSubmitSubscription = new Subscription.Subscription();
                return _this;
            }
            ...
            RxForm.prototype.render = function () {
                return (React.createElement(Comp, __assign({ ref: this.attachFormElement, "formSubmit$": this.formSubmit$, "valueChange$": valueChangeObs ? this.valueChange$ : null, setValue: this.setValue, addInputs: this.handleAddInputs, valid: !this.hasError(), submitted: this.state.submitted }, this.state.formValue, this.props)));
            };
    ...
    return function (Comp) {
        var RxWizardForm = (function (_super) {
            ...
            RxWizardForm.prototype.renderCurrentForm = function () {
                ...
                return (React.createElement(FormComponent, __assign({}, this.props, formValue, { goBack: this.handleGoBack, onSubmit: this.handleSubmit, onError: this.props.onError })));
            };
            RxWizardForm.prototype.render = function () {
                return React.createElement(Comp, __assign({ goTo: this.goTo, renderCurrentForm: this.renderCurrentForm }, this.state, this.props));
            };
